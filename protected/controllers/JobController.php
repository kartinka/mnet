...
class JobController extends Controller
{
        ...
        if(isset($_POST['Job']))
        {
            ...
            if($model->save())
                if(Yii::app()->request->isAjaxRequest){
                    ...
                    $this->redirect(array('user/user/view','id'=>'me'));
        }

        if(Yii::app()->request->isAjaxRequest)
        {
            echo $this->renderPartial('create', array('model' => $model));
            Yii::app()->end();
        } else
	...
	public function actionEdit($id = null)
	{
        ...
        if(isset($_POST['Job']))
        {
            $model = $this->loadModel($_POST['Job']['id']);
            $model->attributes=$_POST['Job'];
            $model->user_id = $_POST['user_id'];
            //var_dump($model->save());
        ...
        if(Yii::app()->request->isAjaxRequest)
        {
            ...
            $this->render('edit', array('model' => $this->loadModel($_POST['id'])));
