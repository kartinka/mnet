    ...
    <div class="row">
        <div class="span7">
            <ul class="nav nav-tabs">
                <li class=""><a href="<?php echo Yii::app()->baseUrl; ?>/home/index">Most Recent</a></li>
                <li class="active"><a href="<?php echo Yii::app()->baseUrl; ?>/feed/open">Unanswered Questions</a></li>
