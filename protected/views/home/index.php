  ...
  <div class="row">
      <div class="span7">
          <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo Yii::app()->baseUrl; ?>/index.php/home/index">Most Recent</a></li>
              <li class=""><a href="<?php echo Yii::app()->baseUrl; ?>/index.php/home/index/feed/open">Unanswered Questions</a></li>
